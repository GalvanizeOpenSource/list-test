{<img src="https://codeclimate.com/github/ShepBook/list-test/badges/gpa.svg" />}[https://codeclimate.com/github/ShepBook/list-test]
{<img src="https://codeclimate.com/github/ShepBook/list-test/badges/coverage.svg" />}[https://codeclimate.com/github/ShepBook/list-test/coverage]

== Galvanize Todo

This is a simple todo list application. There is are todo lists, and todo items associated with those lists.
It is a Ruby on Rails application, and it uses Capybara and Jasmine for its testing suite.
